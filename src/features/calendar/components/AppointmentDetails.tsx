...
export const AppointmentDetails = ({
  ...
  if (!appointment) {
    return (
      <Empty className="dark:bg-bg-btn-secondary/40 bg-bg-btn-secondary/60 h-full">
        <EmptyHeader>
          <EmptyMedia>
            <Calendar className="w-8 h-8 text-muted-foreground" />
          </EmptyMedia>
          <EmptyTitle>Sin cita seleccionada</EmptyTitle>
          <EmptyDescription>
  ...
  return (
    <div className="h-full flex flex-col animate-fade-in border border-primary/15 bg-background rounded-4xl overflow-visible">
      {/* Header */}
      <div className="flex items-start justify-between p-4 border-b border-primary/15 ">
        <div className="flex-1 min-w-0 flex items-center gap-3">
          <div className="h-9 w-9 relative overflow-hidden rounded-full border border-primary/10 bg-muted flex items-center justify-center">
            {userRole === "DOCTOR" ? (
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="rounded-full h-7 w-7 flex-shrink-0 hover:bg-primary/10 hover:text-primary"
                title="Abrir chat"
              >
      ...
      {/* Content SOLO este div es scrolleable */}
      <div className="flex-1 min-h-0 overflow-auto p-4 space-y-4 scrollbar-hide">
        {/* Status and Type */}
        <div className="flex gap-2 flex-wrap">
          <Badge
            className={`${statusVariants[appointment.status]} border text-base`}
          >
        ...
        {appointment.notes && (
          <div className="space-y-2">
            ...
            <div className="flex items-start gap-2 bg-muted rounded-lg">
