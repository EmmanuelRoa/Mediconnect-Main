          ...
          return (
            <div
              ...
              className={cn(
                ...
                isMobile
                  ? "grid-cols-[60px_1fr] px-0"
                  : "grid-cols-[80px_1fr] px-4",
              )}
            >
              <div
                className={cn(
                  "p-2 sm:p-4 text-xs sm:text-sm text-muted-foreground text-right bg-muted/30",
                  isMobile ? "" : "border-r border-primary/15",
                )}
                style={isMobile ? { borderRight: "none" } : {}}
              >
